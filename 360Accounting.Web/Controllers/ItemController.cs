...
namespace _360Accounting.Web.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public ActionResult Edit(string id, long sobId)
        {
            ...
            {
                model.COGSCodeCombination = CodeCombinationHelper.GetCodeCombinations(sobId, AuthenticationHelper.CompanyId.Value)
            ...
            {
                model.SalesCodeCombination = CodeCombinationHelper.GetCodeCombinations(sobId, AuthenticationHelper.CompanyId.Value)
                    .Select(x => new SelectListItem
                    {
                        Text = Utility.Stringize(".", x.Segment1, x.Segment2, x.Segment3, x.Segment4, x.Segment5, x.Segment6, x.Segment7, x.Segment8),
                        Value = x.Id.ToString()
