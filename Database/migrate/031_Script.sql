...
ALTER TABLE [dbo].[tbPayableInvoice] ADD CONSTRAINT [tbPayableInvoice] PRIMARY KEY CLUSTERED ([Id])
...
---------------------------------------------------------------------------
ALTER TABLE [dbo].[tbPayableInvoice] ADD CONSTRAINT [FK_tbPayInvoice_tbVendor] FOREIGN KEY ([VendorId]) REFERENCES [dbo].[tbVendor] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE
ALTER TABLE [dbo].[tbPayableInvoice] ADD CONSTRAINT [FK_tbPayableInvoice_tbVendorSite] FOREIGN KEY ([VendorSitId]) REFERENCES [dbo].[tbVendorSite] ([Id]) ON DELETE NO Action ON UPDATE NO Action
...
ALTER TABLE [dbo].[tbPayableInvoiceDetail] ADD CONSTRAINT [FK_tbPayableInvoiceDetail_tbCodeCombinition] FOREIGN KEY ([CodeCombinationId]) REFERENCES [dbo].[tbCodeCombinitioin] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE
